...
class Algo(EvoAlgo):
    ...
    def evaluate(self):
        ...
        nrange = self.stage * 0.6
        if (nrange < 0.01):
            nrange = 0.01
        self.policy.nn.setnoiserange(nrange)
        ...
        gfit = 0
        self.policy.env.robot.setposturerange(0.03)
        self.policy.nn.setnoiserange(0.01)       # postevaluation with normal motor noise (0.01)
    ...
    def run(self):
        ...
        while (self.steps < self.maxsteps):
            ...
            self.stage = self.steps / self.maxsteps
