...
e_folder = '/home/jonata/evorobotpy2/rerun/incnoise-fix06/experiments'
    ...
    for n in range(0, int(number_of_seeds)):
        ...
        for f in file_list:
            if '.ini' in f:
                if not '.txt' in f:
                    ini_name = f
        seed_command = 'python3 /home/jonata/evorobotpy2/rerun/incnoise-fix06/bin/es.py -f {}'.format(ini_name)
